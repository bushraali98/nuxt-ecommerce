      ...
      <div class="container mx-auto">
        <div class="flex flex-col md:flex-row space-x-4">
          <div class="w-full md:w-1/2">
            <img :src="require('@/assets/product/wom3.webp')" alt="Image 1" class="h-3/4 mb-4 bg-origin-border p-4 border-2 border-solid">
          </div>
        ...
        <div class="container mx-auto">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mx-6">
            <div v-for="product in products" :key="product.id" class="bg-white p-4 rounded shadow">
              <img :src="require('@/assets/product/wom2.webp')" :alt="product.name" class="h-48 w-full object-cover mb-4 hover:cursor-pointer">
